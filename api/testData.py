...
sponsors = [Sponsor("Brick Brewery", link="https://www.facebook.com/brick.brewery?fref=ts"),
            ...
            Sponsor("Domus", link="https://www.facebook.com/domushousing?fref=ts"),
            Sponsor("East Side's Mario's", link="https://www.facebook.com/esm.waterloouniversity?fref=ts"),
            Sponsor("Fat Basrtd Burrito", link="https://www.facebook.com/FatBastardBurritoCo.Waterloo?fref=ts"),
            Sponsor("Frites", link="https://www.facebook.com/frieswithbenefits?fref=ts"),
            Sponsor("Gatorade", link="http://www.pepsicojobs.com/en-ca"),
            Sponsor("Spitz", link="http://www.pepsicojobs.com/en-ca"),
            Sponsor("GE", link="http://www.ge.com/ca/careers"),
            Sponsor("Gino's Pizza", link="http://www.ginospizza.ca/"),
            Sponsor("Huether Hotel", link="https://www.facebook.com/HuetherHotel?fref=ts"),
            Sponsor("Kik", link="http://www.kik.com/careers/"),
            Sponsor("Maxwell's", link="http://maxwellswaterloo.com/"),
            ...
            Sponsor("Owl Rafting",link="http://www.owl-mkc.ca/owl/"),
            Sponsor("Pita Factory",link="http://www.pitafactory.com/"),
            Sponsor("Reds Whites and Brews",link="http://www.redswhitesandbrews.ca/"),
            Sponsor("SBESS",link="https://www.facebook.com/LazSoc/?fref=ts"),
            Sponsor("Sentry",link="Shoeless Joe's - Waterloo"),
            ...
            Sponsor("Snapple Vodka",link="http://www.snapple.com/"),
            Sponsor("SportZone",link="https://www.facebook.com/sportszonecanada?fref=ts"),
            Sponsor("Traces",link="http://traces.com/"),
            ...
            Sponsor("Waterloo",link="https://www.facebook.com/waterloonetworks?fref=ts"),
