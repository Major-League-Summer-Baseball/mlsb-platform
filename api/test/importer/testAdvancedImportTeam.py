...
class TestTeamImportExtracingFunction(TestSetup):
    ...
    def testExtractPlayerInformation(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            self.assertEqual(
                result['name'], name, "Player name was not extracted"
            )
            self.assertEqual(
                result['email'], email, "Player email was not extracted"
            )
            self.assertEqual(
                result['gender'],
                gender,
            ...
            self.assertEqual(
                result['gender'], gender, "Player gender was not extracted"
            )
    ...
    def testExtractPlayers(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            players = [
                [player_one['email'], player_one['name'], player_one['gender']],
                [player_two['email'], player_two['name'], player_two['gender']]
            ]
            ...
            self.assertEqual(
                len(result['player_info']), 2, "Some player was not extracted"
            )
            ...
            # check player one
            self.assertEqual(
                result['player_info'][0]['player_id'],
                None,
                "Player id set for non-existent player"
            )
            self.assertEqual(
                result['player_info'][0]['name'],
                player_one['name'],
                "Player name was not extracted"
            )
            self.assertEqual(
                result['player_info'][0]['email'],
                player_one['email'],
            ...
            # check player two
            self.assertEqual(
                result['player_info'][1]['player_id'],
                None,
                "Player id set for non-existent player"
            )
            self.assertEqual(
                result['player_info'][1]['name'],
                player_two['name'],
                "Player name was not extracted"
            )
            self.assertEqual(
                result['player_info'][1]['email'],
                player_two['email'],
                "Player email was not extracted"
            )
            self.assertEqual(
    ...
    def testExtractColumnIndicesLookup(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            self.assertEqual(
                0, lookup['email'], "Did not extract email header"
            )
            self.assertEqual(
                1, lookup['name'], "Did not extract name header"
            )
            self.assertEqual(
                2, lookup['gender'], "Did not extract gender header"
            )
...
class TestTeamImportAddTeam(TestSetup):
    ...
    def testAddTeamAlreadyExists(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            self.assertEqual(
                importer.warnings, [], "Importing team gave warnings"
            )
    ...
    def testAddTeam(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            teams = (
                ...
                .filter(Team.year == date.today().year)
            ).all()
    ...
    def testAddTeamPlayerAlreadyExists(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            player = self.add_player(
                player_name, player_email, gender=player_gender
            )
            ...
            self.assertTrue(
                player['player_id'] in player_ids,
