...
class TestBat(TestSetup):
    ...
    def testBateInvalidPost(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            player = self.add_player(
                "Test Player", "TestPLayer@mlsb.ca", gender="M"
            )
            params = {}
            expect = {
                'message': {
            ...
            expect = {
                'details': INVALID_ID, 'message': GameDoesNotExist.message
            }
            error_message = (
                Routes['bat'] + " POST: request with invalid game id"
            )
            self.postInvalidTest(
                Routes['bat'],
                params,
            ...
            expect = {
                'details': str(INVALID_ID),
                'message': TeamDoesNotExist.message
            }
            error_message = (
                Routes['bat'] + " POST: request with invalid team id"
            )
            self.postInvalidTest(
                Routes['bat'],
                params,
            ...
            error_message = (
                Routes['bat'] + " POST: request with invalid rbi"
            )
            self.postInvalidTest(
                Routes['bat'],
                params,
            ...
            expect = {
                'details': 'Bat - inning', 'message': InvalidField.message
            }
            error_message = (
                Routes['bat'] + " POST: request with invalid inning"
            )
            self.postInvalidTest(
                Routes['bat'],
                params,
            ...
            error_message = (
                Routes['bat'] + " POST: request with invalid hit"
            )
            self.postInvalidTest(
                Routes['bat'],
                params,
    ...
    def testBatList(self):
        ...
        with app.app_context(), app.test_request_context():
            # test a get with bat
            error_message = (
                Routes['bat'] + " GET Failed to return list of bats"
            )
    ...
    def testBatPut(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            expect = {
                'details': INVALID_ID, 'message': BatDoesNotExist.message
            }
            ...
            params = {
                ...
                'inning': 1}
            expect = {
                'details': 'Bat - rbi', 'message': InvalidField.message
            }
            ...
            second_team = self.add_team(
                "test team two", sponsor=sponsor, league=league
            )
            second_player = self.add_player(
                "test player two", "testPlayerTwo@mlsb.ca", "M"
            )
            params = {
