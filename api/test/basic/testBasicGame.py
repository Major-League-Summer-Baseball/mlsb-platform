...
class TestGame(TestSetup):
    ...
    def testGameInvalidPost(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            error_message = (
                Routes['game'] + " POST: request with missing parameter"
            )
            ...
            expect = {
                'details': 'Game - date', 'message': InvalidField.message
            }
            error_message = (
                Routes['game'] + " POST: request with invalid date"
            )
            self.postInvalidTest(
                Routes['game'],
                params,
            ...
            error_message = (
                Routes['game'] + " POST: request with invalid away team id"
            )
            self.postInvalidTest(
                Routes['game'],
                params,
    ...
    def testGameListAPI(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            error_message = (
                Routes['game'] + " GET Failed to return list of games"
            )
    ...
    def testGamePut(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            expect = {
                'details': 'Game - time', 'message': InvalidField.message
            }
            ...
            expect = {
                'details': 'Game - status', 'message': InvalidField.message
            }
            ...
            expect = {
                'details': 'Game - field', 'message': InvalidField.message
            }
