...
@summary: Tests all the basic league event APIS
'''
...
class TestLeagueEvent(TestSetup):
    ...
    def testLeagueEventInvalidPost(self):
        ...
        error_message = (Routes['league_event'] +
                         " POST: request with missing parameter")
        self.postInvalidTest(Routes['league_event'],
                             params,
    ...
    def testLeagueEventListAPI(self):
        ...
        self.getListTest(Routes['league_event'], error_message=error_message)
    ...
    def testLeagueEventAPIGet(self):
        ...
        error_message = Routes['league_event'] + " Get: Invalid League Event"
        self.getTest(Routes['league_event'] + "/" + str(INVALID_ID),
    ...
    def testLeagueEventAPIPut(self):
        ...
        error_message = Routes['league_event'] + ' PUT:Invalid league event ID'
        self.putTest(Routes['league_event'] + '/' + str(INVALID_ID),
                     params,
                     LeagueEventDoesNotExist.status_code,
                     self.assertEqual,
                     result,
        ...
        league_event_id = str(league_event['league_event_id'])
        self.putTest(Routes['league_event'] + f'/{league_event_id}',
                     params,
                     InvalidField.status_code,
                     self.assertEqual,
                     result,
        ...
        # now get it
        error_message = Routes['league_event'] + " Get: valid League Event"
        self.getTest(Routes['league_event'] + f'/{league_event_id}',
                     SUCCESSFUL_GET_CODE,
                     self.assertLeagueEventModelEqual,
                     league_event,
                     error_message=error_message)
