...
class TestLeague(TestSetup):
    ...
    def testLeagueInvalidPost(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            error_message = (
                Routes['league'] + " POST: request with missing parameter"
            )
            ...
            result = {
                'details': 'League - name', 'message': InvalidField.message
            }
            error_message = (
                Routes['league'] + " POST: request with invalid league_name"
            )
            self.postInvalidTest(
                Routes['league'],
                params,
    ...
    def testLeagueAPIGet(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            # valid League id
            self.getTest(
                Routes['league'] + "/" + str(league['league_id']),
                SUCCESSFUL_GET_CODE,
