...
@summary: Tests all the basic division APIS
'''
...
class TestDivision(TestSetup):
    ...
    def testDivisionInvalidPost(self):
        ...
        error_message = (Routes['division'] +
                         " POST: request with missing parameter")
        self.postInvalidTest(Routes['division'],
                             params,
        ...
        result = {'details': 'Division - name',
                  'message': InvalidField.message}
        error_message = (Routes['division'] +
                         " POST: request with invalid division_name")
        self.postInvalidTest(Routes['division'],
                             params,
                             InvalidField.status_code,
                             self.assertEqual,
        ...
        result = {'details': 'Division - short name',
                  'message': InvalidField.message}
        error_message = (Routes['division'] +
    ...
    def testDivisionAPIGet(self):
        ...
        self.getTest(Routes['division'] + "/" + str(INVALID_ID),
        ...
        # valid Division id
        self.getTest(Routes['division'] + "/" + str(division['division_id']),
                     SUCCESSFUL_GET_CODE,
    ...
    def testDivisionAPIPut(self):
        ...
        self.putTest(Routes['division'] + '/' + str(INVALID_ID),
                     params,
                     DivisionDoesNotExist.status_code,
                     self.assertEqual,
                     result,
        ...
        self.putTest(Routes['division'] + '/' + str(division['division_id']),
                     params,
                     InvalidField.status_code,
                     self.assertEqual,
                     result,
        ...
        result = {'details': 'Division - shortname',
                  'message': InvalidField.message}
        error_message = Routes['division'] + ' PUT: Invalid parameters'
        self.putTest(Routes['division'] + '/' + str(division['division_id']),
                     params,
