...
class TestEspys(TestSetup):
    ...
    def testEspysApiGet(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            # invalid espy id
            result = {
                'details': INVALID_ID, 'message': EspysDoesNotExist.message
            }
            error_message = Routes['espy'] + " GET invalid espy id"
            self.getTest(
                Routes['espy'] + "/" + str(INVALID_ID),
    ...
    def testEspysApiInvalidPost(self):
        ...
        with app.app_context(), app.test_request_context():
            ...
            error_message = (
                Routes['espy'] + " POST: request with missing parameter"
            )
            ...
            error_message = (
                Routes['espy'] + " POST: request with invalid team id"
            )
            self.postInvalidTest(
                Routes['espy'],
                params,
            ...
            error_message = (
                Routes['espy'] + " POST: request with invalid sponsor id"
            )
            self.postInvalidTest(
                Routes['espy'],
                params,
